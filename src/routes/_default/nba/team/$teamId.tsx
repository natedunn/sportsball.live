...
export const Route = createFileRoute("/_default/nba/team/$teamId")({
  ...
  loader: async ({ context, params }) => {
    // Ensure overview data is loaded for SSR
      ...
      if (convexPlayer) {
        ...
        return {
          ...
          stats: {
            ...
            fgPct: convexPlayer.fieldGoalPct / 100 || player.stats.fgPct, // Convex stores as 45.2, we need 0.452
