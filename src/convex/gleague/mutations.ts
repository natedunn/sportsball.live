...
export const upsertTeam = internalMutation({
	...
	handler: async (ctx, args) => {
		...
		if (existing) {
			...
			return await ctx.db.insert("gleagueTeam", data);
		}
	},
});
...
export const upsertPlayer = internalMutation({
	...
	handler: async (ctx, args) => {
		...
		if (existing) {
			...
			return await ctx.db.insert("gleaguePlayer", data);
		}
	},
});
...
export const upsertGameEvent = internalMutation({
	...
	handler: async (ctx, args) => {
		...
		if (existing) {
			...
			return await ctx.db.insert("gleagueGameEvent", data);
		}
	},
});
...
export const upsertTeamEvent = internalMutation({
	...
	handler: async (ctx, args) => {
		...
		if (existing) {
			...
			return await ctx.db.insert("gleagueTeamEvent", data);
		}
	},
});
...
export const upsertPlayerEvent = internalMutation({
	...
	handler: async (ctx, args) => {
		...
		if (existing) {
			...
			return await ctx.db.insert("gleaguePlayerEvent", data);
		}
	},
});

// Recalculate seasonal averages for a team from all gleagueTeamEvent rows
...
// Recalculate seasonal averages for a player from all gleaguePlayerEvent rows
