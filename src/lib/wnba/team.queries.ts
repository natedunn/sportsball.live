...
import {
  ...
  fetchTeamLeaders,
  fetchTeamInjuries,
} from "@/lib/wnba/team.server";

export const teamOverviewQueryOptions = (teamSlug: string) =>
  queryOptions({
    queryKey: ["wnba", "team", teamSlug, "overview"],
...
export const teamRosterQueryOptions = (teamSlug: string) =>
  queryOptions({
    queryKey: ["wnba", "team", teamSlug, "roster"],
...
export const teamScheduleQueryOptions = (teamSlug: string) =>
  queryOptions({
    queryKey: ["wnba", "team", teamSlug, "schedule"],
...
export const teamStatsQueryOptions = (teamSlug: string) =>
  queryOptions({
    queryKey: ["wnba", "team", teamSlug, "stats"],
...
export const teamLeadersQueryOptions = (teamSlug: string) =>
  queryOptions({
    queryKey: ["wnba", "team", teamSlug, "leaders"],
